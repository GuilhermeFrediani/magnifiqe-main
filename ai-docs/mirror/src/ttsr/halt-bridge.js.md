...
## Summary
Stack Perfeita MCP — TTSR-HALT Integration Bridge Connects TTSR engine with existing HALT patterns from config.js BAD_PATTERNS. Converts BAD_PATTERNS regex entries into TTSR rules for lazy-loaded monitoring.

...
## Summary
Stack Perfeita MCP — TTSR Rule Types + Bucket Routing Defines rule schema and routing logic (TTSR vs rulebook vs always-apply). Port of OMP's rule.ts + rule-buckets.ts pattern.

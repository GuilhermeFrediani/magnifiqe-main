...
## Summary
@module prompt-standards RFC 2119 prompt conventions and density rules. Based on the OMP System Prompts pattern: Dense, imperative, RFC-keyed. Tags carry semantics.

## Imports
- none

## Exports
- `validatePromptStandards`
- `enforceDensity`
- `extractDirectives`

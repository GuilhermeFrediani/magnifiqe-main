...
## Summary
Stack Perfeita MCP — Tool Result Interceptor Protocol Defines the interface for compressing specific tool outputs before general compression. Port of Headroom's ToolResultInterceptor pattern.

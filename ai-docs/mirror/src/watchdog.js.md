...
## Summary
Stack Perfeita MCP — Watchdog tools Output dedup tracking, session watchdog timing, test execution monitoring, and session health diagnostics.

...
## Summary
@module phase1-tools Phase 1 tool registrations: Semantic Compression + Prompt Standards.

## Imports
- `zod`
- `./safety-guards.js`
- `./semantic-compression.js`
- `./prompt-standards.js`

## Exports
- `registerSemanticCompressionTools`
- `registerPromptStandardsTools`

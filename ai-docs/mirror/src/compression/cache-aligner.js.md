# src/compression/cache-aligner.js
...
## Summary
Stack Perfeita MCP — CacheAligner (Detector-Only) Detects volatile content (UUIDs, timestamps, JWTs, hex hashes) in text. Does NOT mutate — emits warnings and tracks prefix stability. Port of Headroom's cache_aligner.py pattern.

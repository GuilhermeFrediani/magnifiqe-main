...
## Summary
Stack Perfeita MCP — Circuit Breaker After N consecutive pipeline failures, pass through without compression. Port of Headroom's pipeline.py circuit breaker pattern.

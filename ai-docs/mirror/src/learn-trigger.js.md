...
## Summary
Stack Perfeita MCP — Learn Trigger Periodic and on-demand triggers for the headroom_learn cycle. Scans .claude/ sessions, analyzes patterns, writes recommendations.

...
## Summary
Stack Perfeita MCP — TTSR Manager Bridges the TTSR engine into the MCP server as managed tools. Exposes ttsr_check_output and ttsr_stats for runtime rule monitoring.

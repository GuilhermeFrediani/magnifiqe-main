# test/validators-handlers.test.js
...
## Summary
Handler-level tests for src/validators.js tools. Uses createMockServer pattern — invokes handlers directly via mock registration.

...
## Summary
Handler-level tests for src/profiles.js, src/roles.js, src/task-runtime.js, src/commands.js Uses the createMockServer pattern: register tools into a mock server, then invoke handlers directly and assert on the returned content.

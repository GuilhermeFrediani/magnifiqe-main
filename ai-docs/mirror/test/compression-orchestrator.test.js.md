# test/compression-orchestrator.test.js
...
## Summary
Test suite for src/compression-orchestrator.js Tests: compressToolOutput, decompressOutput, getCompressionStats

## Imports
- `node:test`
- `node:assert`
- `../src/compression/circuit-breaker.js`

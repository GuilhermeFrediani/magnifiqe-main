...
describe('TOPIC_MAP', () => {
  it('should map common keywords to rule files', () => {
    ...
    assert.strictEqual(TOPIC_MAP['live'], '13-live-council-runtime.md');
    assert.strictEqual(TOPIC_MAP['runtime'], '13-live-council-runtime.md');
  });
...
describe('RULE_DESCRIPTIONS', () => {
  it('should have descriptions for all known rule files', () => {
    const expectedFiles = [
      ...
      '12-council-deliberation.md',
      '13-live-council-runtime.md',
    ];

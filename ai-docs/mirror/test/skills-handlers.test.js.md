...
## Summary
Handler-level tests for src/skills.js MCP tools. Tests: list_skills, get_skill via createMockServer pattern. Since the project may not have a .claude/skills directory, we create temporary skill fixtures before the suite and clean up after.

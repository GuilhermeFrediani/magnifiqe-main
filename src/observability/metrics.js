 ...
 * Counters, histograms, and gauges for compression, tools, and TTSR performance.
...
class Histogram {
  #buckets = []; #sum = 0; #count = 0; static MAX_SAMPLES = 1000;
  constructor() { }
  observe(value) {
    if (this.#buckets.length >= Histogram.MAX_SAMPLES) {
      this.#buckets.shift();
    }
 ...
 * Tracks compression, tools, and TTSR performance.
 */
